...
namespace OpenEhr.Validation
{
    public class RmValidator
    {
        ...
        protected RmValidator(IConfigurationSource configurationSource)
        {
            Check.Require(configurationSource != null, "configurationSource must not be null.");
       ...
       private void Validate(PartyProxy partyProxy)
        ...
        public static void Validate(OpenEhr.RM.Common.Archetyped.Impl.Locatable locatable, IConfigurationSource configSource)
        {
            ...
            RmValidator instance = new RmValidator(configSource);
        ...
        protected ITerminologyService TerminologyService
        {
            ...
            {
                Check.Require(configurationSource != null, "configurationSource must not be null.");
                return TerminologyServiceFactory.Create(configurationSource);
            }
        }
