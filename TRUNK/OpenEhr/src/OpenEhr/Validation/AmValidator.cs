...
namespace OpenEhr.Validation
{
    ...
    {
        protected AmValidator(IConfigurationSource configurationSource)
        ...
        internal static bool ValidateCObject(CObject cObject, IConfigurationSource configurationSource)
        {
            AmValidator amValidator = new AmValidator(configurationSource);
        ...
        internal static bool ValidateCAttribute(CAttribute cAttribute, IConfigurationSource configurationSource)
        {
            AmValidator amValidator = new AmValidator(configurationSource);
